...
-(NSString *)copyRadioAccessTechnology:(CTXPCServiceSubscriptionContext *)arg1 error:(id*)arg2 ;
...
-(NSString *)getOperatorName:(CTXPCServiceSubscriptionContext *)context error:(id*)arg2 ;
...
-(id)getSubscriptionInfoWithError:(id*)arg1; // 获取的是[CTXPCServiceSubscriptionContext]列表
...
//-(id)isEmbeddedSIMOnlyConfig:(id*)arg1; // 不存在的方法
...
//-(SCD_Struct_Co16)reliableNetworkFallback:(id)arg1 error:(id*)arg2 ;
